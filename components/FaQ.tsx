...
const FaQ: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        "Companies can collaborate with us through recruitment, workshops, mentorship, or sponsorships. For opportunities, contact our industry relations team at stc_iitp@iitp.ac.in",
    },
    {
