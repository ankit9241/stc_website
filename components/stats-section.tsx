...
const StatsSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-gray-50 rounded-2xl shadow-md w-full px-4 pt-8 sm:px-6 sm:pt-10 md:px-10 md:pt-12">
      {/* left section */}
