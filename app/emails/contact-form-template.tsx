    ...
    <div style={containerStyle}>
      ...
      <div style={contentStyle}>
        ...
        <div style={footerStyle}>
          <p>This email was sent from the contact form on STC IIT Patna website.</p>
          <p style={{ margin: '8px 0 0', opacity: 0.8 }}>
            &copy; {new Date().getFullYear()} Student Technical Council, IIT Patna. All rights reserved.
          </p>
